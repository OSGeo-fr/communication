 ...
 *   The form state.
 */
function osgeo2013_form_system_theme_settings_alter(&$form, &$form_state) {

  $form['mtt_settings'] = array(
    '#type' => 'fieldset',
    '#title' => t('OSGEO 2013 Theme Settings'),
    '#collapsible' => FALSE,
	'#collapsed' => FALSE,
  );
  ...
  $form['mtt_settings']['breadcrumb']['breadcrumb_display'] = array(
	...
	'#default_value' => theme_get_setting('breadcrumb_display','osgeo2013'),
  );
  
  $form['mtt_settings']['breadcrumb']['breadcrumb_separator'] = array(
    '#type' => 'textfield',
    '#title' => t('Breadcrumb separator'),
	'#default_value' => theme_get_setting('breadcrumb_separator','osgeo2013'),
    '#size'          => 5,
    '#maxlength'     => 10,
  );
  ...
  $form['mtt_settings']['slideshow']['slideshow_display'] = array(
	...
	'#default_value' => theme_get_setting('slideshow_display','osgeo2013'),
  );
  
  $form['mtt_settings']['slideshow']['slideshow_js'] = array(
    '#type' => 'checkbox',
    '#title' => t('Include slideshow javascript code'),
	'#default_value' => theme_get_setting('slideshow_js','osgeo2013'),
  );
  ...
  $form['mtt_settings']['slideshow']['slideshow_effect'] = array(
	...
	'#default_value' => theme_get_setting('slideshow_effect','osgeo2013'),
    '#options' => array(
		'blindX' => t('blindX'),
		'blindY' => t('blindY'),
		'blindZ' => t('blindZ'),
  ...
  $form['mtt_settings']['support']['responsive']['responsive_meta'] = array(
	...
	'#default_value' => theme_get_setting('responsive_meta','osgeo2013'),
  );
  ...
  $form['mtt_settings']['support']['responsive']['responsive_respond'] = array(
	...
	'#default_value' => theme_get_setting('responsive_respond','osgeo2013'),
