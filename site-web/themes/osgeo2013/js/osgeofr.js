jQuery( document ).ready(function() {
	...
	jQuery('#block-menu-menu-social div.content li:nth-child(1) a').prepend('<span class="icon-twitter"></span> '); // twitter
	jQuery('#block-menu-menu-social div.content li:nth-child(2) a').prepend('<span class="icon-github"></span> '); // github
