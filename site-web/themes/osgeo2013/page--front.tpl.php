...
<div id="header">
    ...
    <div id="header-inside" class="container_12 clearfix">
        ...
        <div>
            ...
            <?php if ($logo): ?>
            <a href="<?php print check_url($front_page); ?>" title="<?php print t('Home'); ?>"><img id="logo" src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" /></a>
            <?php endif; ?>
...
<div id="header-menu">
    ...
    <div id="header-menu-inside" class="container_12 clearfix">
    	...
    	<div class="grid_12">
            ...
            <a title="S'abonner au flux RSS" class="feed-icon" href="<?php echo base_path(); ?>rss.xml"><span class="feed-text">S'abonner au flux RSS</span></a>
            </div>
			...
			<div id="latest-news">
				...
				<ul>
					<?php foreach($latestnews as $news) { ?>
						...
						<?php $link = drupal_get_path_alias('node/'.$news['nid']); ?>
						<li><a href="<?php echo drupal_get_path_alias('node/'.$news['nid']); ?>"><?php echo $news['title']; ?></a></li>
...
<div id="footer-bottom">
    ...
    <div id="credits" class="container_12 clearfix">
        <div class="grid_12">
        <p><a href="http://osgeo.asso.fr/galette/">Espace adhérents</a> | <a href="<?php echo base_path(); ?>user/login">Se connecter</a> | Site réalisé avec <a href="http://www.drupal.org">drupal</a>. Mise en page basée sur le thème conçu par <a href="http://www.kaolti.com/">Zsolt Kacso</a>.</p>
        </div>
    </div>
    <!-- EOF: #credits -->
</div><!-- EOF: #footer -->
